...
{
    public sealed class Cattleya : Theme
    {
        private static readonly Color mainThemeColor = Color.FromArgb(150, 255, 0, 255);
        ...
        public override string Name { get; } = "Cattleya";
        ...
        private sealed class ThemeImageButtonStyle : BaseImageButtonStyle
        {
            ...
            public override Color MouseDownBackColor { get; } = Color.FromArgb(200, mainThemeColor);
            public override Color MouseOverBackColor { get; } = mainThemeColor;
        }
        ...
        private sealed class ThemeCustomTextBoxStyle : BaseCustomTextBoxStyle
        {
            ...
            public override Color BorderFocusColor { get; } = Color.RebeccaPurple;
        ...
        private sealed class ThemePanelStyle : BasePanelStyle
        {
            ...
            public override Color SecondaryBackColor { get; } = mainThemeColor;
            public override Color BorderColor { get; } = mainThemeColor;
        }
    }
}
